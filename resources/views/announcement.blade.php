    ...
    <section class="login">
        <div class="login_box">
            <div class="solo">
                ...
                <h2 class="solo-noqual-h2">{{ $participant->name }}</h2>
                <h2>{{ $participant->student_id }}</h2>
                <h2>{{ $participant->study_program }}</h2>
                <h3 class="solo-qual-h3">
                    Selamat Bergabung Di Keluarga Besar Forum Open Source Teknik Informatika
                </h3>
    ...
    <section class="login">
        <div class="login_box">
            <div class="solo">
                ...
                <h3 class="solo-error-h3">Mungkin Terdapat Kesalahan Penulisan</h3>
                <h3>Bisa Di Coba Kembali Ya</h3>
                <h3>Terima Kasih</h3>
                <h2 class="solo-error-h2">FOSTI UMS</h2>
            </div>
        </div>
    </section>
    @endif
